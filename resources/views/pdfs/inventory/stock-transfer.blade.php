...
<head>
    <meta charset="utf-8">
    <title>Traslado {{ $record->reference }}</title>
    <style>
        @page {
...
<table class="header">
    <tr>
        ...
        <td style="text-align: right;">
            <div class="title">Traslado de inventario</div>
...
<table class="meta">
    ...
    <tr>
        ...
        <td>{{ $record->movement_at ? \Carbon\Carbon::parse($record->movement_at)->format('d/m/Y H:i') : '—' }}</td>
...
<table class="signatures">
    <tr>
        ...
        <td><div class="line">Recibe</div></td>
        <td><div class="line">Autoriza</div></td>
    </tr>
</table>
</body>
</html>
