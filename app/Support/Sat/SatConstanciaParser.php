...
class SatConstanciaParser
{
    ...
    private function readable(?string $value): ?string
    {
        ...
        $replacements = [
            ...
            'BIKES CYCLES AND PARTSMEXICO' => 'BIKES CYCLES AND PARTS MEXICO',
            'BIKES CYCLES ANDPARTS MEXICO' => 'BIKES CYCLES AND PARTS MEXICO',
            'BIKES CYCLESAND PARTS MEXICO' => 'BIKES CYCLES AND PARTS MEXICO',
            'CEDIS GRUPO L 7' => 'CEDIS GRUPO L7',
            'GRUPO L 7' => 'GRUPO L7',
            'GRUPOL7' => 'GRUPO L7',
            'BIKESCYCLESANDPARTSMEXICO' => 'BIKES CYCLES AND PARTS MEXICO',
            'BIKESCYCLESANDPARTS' => 'BIKES CYCLES AND PARTS',
            'ANDPARTS' => 'AND PARTS',
            'PARTSMEXICO' => 'PARTS MEXICO',
