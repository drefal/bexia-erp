...
class EmployeePayrollPerceptionApplication extends Model
{
    protected $fillable = [
        'company_id',
        'employee_payroll_perception_id',
        'payroll_run_id',
        'payroll_run_line_id',
    ...
    {
        return $this->belongsTo(\App\Models\EmployeePayrollPerception::class, 'employee_payroll_perception_id');
    }
